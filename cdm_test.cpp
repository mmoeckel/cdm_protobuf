...
int main(int argc, char *argv[])
{
    ...
    cdm.setObject1Metadata("48113", "2019-001A", "EOSCAT", "ALWES-1", "NONE", CDM::CALCULATED, CDM::NO, CDM::GCRF);
    cdm.setObject2Metadata("50129", "2020-014A", "EOSCAT", "PACMAN", "NONE", CDM::DEFAULT, CDM::NO, CDM::GCRF);
